...
- [`docs/alternating-core-unused-phase-target-completion.md`](docs/alternating-core-unused-phase-target-completion.md): unused-phase completion and hard-literal saturation.
...
1. Classify or discharge hard-literal-saturated residual blocks and centre-only replacement blockers, using exact phase/arithmetic roles and without charging prospective targets.
2. For each recurrent simple macro cycle, prove current payment, strict bounded field descent, physical impossibility or a capacity-one cycle ticket; also prove polynomial bounds for the required outer alphabets.
