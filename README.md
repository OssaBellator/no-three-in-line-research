...
1. Construct AC3ki-complete states for the unresolved common-residual and support-disjoint target alternatives; forbidden and prospective targets must remain unpaid.
2. Terminate every repeated decorated macro edge from AC3kc by a current payment theorem, strict bounded descent or capacity-one macro ticket, and prove polynomial bounds for the required outer alphabets.
3. Finish the residual AC3ie boundary/petal terms and any owner rows still returning occurrence failure or coherence mismatch.
