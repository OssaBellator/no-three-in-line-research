...
1. Construct AC3ki-complete states for unresolved common-residual and support-disjoint target alternatives; forbidden and prospective targets must remain unpaid.
2. Terminate every repeated decorated macro edge from AC3kc by current payment, strict bounded descent or a capacity-one macro ticket, and prove polynomial bounds for the required outer alphabets.
3. Obtain the common-parent/private-payment hypotheses for recurrent petal families or classify their exact parent/payment reset; the collateral side is closed by AC3kn--AC3kq.
