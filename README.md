...
1. Install and pay the centred hard-literal/common-residual/support-disjoint and owner-resource fans returned by AC3jl without charging prospective target geometry.
2. Fill the AC3jz current/physical/coherent/payable chart for every live carry/BDA/RI/protected owner and classify genuine outer reset edges.
3. Build the global bounded AC4 potential, then close the AC3ie boundary/petal terms not represented in one common host.
