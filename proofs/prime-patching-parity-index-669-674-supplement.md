# Prime-patching parity index supplement: docs 669--674
...
- The canonical seventeenth correction deletes and inserts five points with equal
  row and column multisets.
- Component-exact Hall packing selects an independent set in each disconnected
  resource-overlap component before applying the separate centre-conflict loss.
- The threshold score is linear, so facet verification, transportation minima, and
...
The tranche supplies exact finite transitions and sharper conditional interfaces,
but no complete recurrent or asymptotic coordinate source path. Candidate
