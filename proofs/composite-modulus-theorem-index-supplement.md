...
|---|---|---|---|
| CMR385--388 | Matching-vertex wall/secant-star split, exact full-prefix token count, fresh-token packing, and the repeated-full-token endpoint | PROVED | `docs/133-prime-power-line-energy-token-endpoint.md` |
| CMR389--392 | Exact two-dimensional full-token stock, dynamic reintroduction inventory, endpoint/witness/ancestry decomposition, and depth-dependent stock bounds | PROVED / PROVED UNDER THE CMR349 HYPOTHESES | `docs/134-prime-power-full-token-reintroduction.md` |
