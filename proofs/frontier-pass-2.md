...
The recurrent non-scalar cycle is localized by cycle-space chords, least-field restoration gates and exact balanced-floor wall/source pairs. Bounded initial source mass, externally paid replenishment and finite acyclic internal source creation now pay even unbounded jump magnitudes. Remaining BDA6 work is arithmetic payment or impossibility of the selected exact pairs, genuinely cyclic source dependencies, unbounded dependency/edge dictionaries and missing physical predecessor lineage.
