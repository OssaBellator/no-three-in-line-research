...
The branch now has an exact reservoir quotient, Hall-core/cause banks, a global-shortage potential, and finite accounts for both acyclic and conservative cyclic adverse sources. Remaining GC5 work is physical payment or impossibility of overloaded causes, proof of nonamplification for concrete adverse cycles, unbounded dictionaries, untagged feedback, clean-height preservation and local resampling.
