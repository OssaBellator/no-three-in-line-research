...
Mixed-orientation legality now has cardinality, weighted-load, one-heavy-atom, iterated heavy-core and exact core-capacity routes. A compatible terminal fan also transfers quantitatively to one finite barrier/neutral output ledger. Remaining SAS6 work is arithmetic proof of core shareability and output lower bounds, classification of terminal barrier versus consumable neutral ledgers, boundary profiles and exact balanced compression.
