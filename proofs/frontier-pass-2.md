...
The recurrent non-scalar cycle is now localized in two complementary ways:
...
The remaining BDA6 work is edge-specific: discharge the reachable restoration classes for balanced-floor, rank-two/rank-three and unresolved ordinary-role profiles by current payment, strict arithmetic descent, physical impossibility or finite tickets.
