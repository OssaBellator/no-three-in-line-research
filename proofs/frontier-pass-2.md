...
The bounded-reservoir branch now has an exact finite quotient, a canonical weighted Hall core, its complete missing rectangle and a finite cause-capacity payment bank. Remaining GC5 work is physical payment or impossibility of overloaded target-common/global causes, pure global donor shortage, replenishable or unbounded cause/donor dictionaries, untagged feedback, clean-height preservation and local superregular resampling.
