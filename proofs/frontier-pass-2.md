...
The bounded-reservoir branch now has an exact finite quotient, a canonical weighted Hall core, its complete missing rectangle, a finite cause-capacity bank and an exact potential for pure global shortage. Remaining GC5 work is physical payment or impossibility of overloaded target-common/global causes and adverse recreation/destruction sources, genuinely replenishable or unbounded dictionaries, untagged feedback, clean-height preservation and local superregular resampling.
