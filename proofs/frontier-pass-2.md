...
The recurrent non-scalar cycle is localized by restoration gates and exact wall/source pairs. Initial mass, paid deposits, acyclic creation and conservative cyclic SCC reuse now have finite accounts. Remaining work is arithmetic payment or impossibility of the selected exact pairs, proof of nonamplification for concrete source cycles, unbounded dictionaries and incomplete physical lineage.
