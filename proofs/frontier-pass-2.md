...
The terminal combinatorial and label recurrence is polynomial, and the two-target secant lift has no hidden long orientation cycle. Remaining RI6 work is arithmetic and payment specific:

1. classify or absorb reachable exact restoration and fixed-secant classes;
2. prove physical owner/coherence payment;
