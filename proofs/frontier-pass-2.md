...
Mixed-orientation legality now has heavy-core, capacity and output-ledger routes. Compatible fan output separates into terminal barrier or consumable neutral mass and then compresses to a finite exact boundary profile without cancellation. Remaining SAS6 work is proving concrete core shareability and output lower bounds, validating the physical nonnegative boundary classification, and connecting the retained profile to exact balanced compression.
