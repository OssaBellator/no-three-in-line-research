...
Mixed-orientation legality now has heavy-core, capacity and output-ledger routes. A compatible fan separates quantitatively into terminal barrier mass or consumable neutral mass. Remaining SAS6 work is proving concrete core shareability and output lower bounds, validating the physical barrier/neutral classification, and connecting the certificate to boundary profiles and exact balanced compression.
