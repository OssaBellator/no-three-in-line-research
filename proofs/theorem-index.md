...
| SAS6 | Arithmetic batching or classification of concentrated swap certificates | OPEN; DONOR BANKS NOW HAVE A GLOBAL COMPATIBILITY GRAPH, EXACT ADDITIVE ENERGY AND A MULTIPLICITY-THREE REPAIR ROUTER, WITH GAIN COMPARISON TO ORIGINAL REFLECTED MASS, ARITHMETIC CLASSIFICATION OF REPAIRED RECORDS AND HIGH-INCIDENCE/BOUNDARY PROFILES REMAINING | `docs/sparse-algebraic-spread.md` |
