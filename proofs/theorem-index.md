...
| GC5 | Clean-host endpoint theorem | OPEN; AGGREGATE PRIVATE AND TARGET-COMMON LATENT SOURCES NOW PAY WHEN THEIR EXACT CAPACITY INEQUALITIES HOLD, WITH SOURCE-FREE AND EXPLICIT CAPACITY-OVERLOAD RESIDUALS, POOL DEPLETION, GLOBAL CONTEXT CAUSES AND LOCAL SUPERREGULAR RESAMPLING REMAINING | `docs/geometric-cleaning.md` |
