...
| GC5 | Clean-host endpoint theorem | OPEN; FIXED-TARGET OVERLOAD DEMAND NOW ROUTES TO NORMALIZED PAYMENT, ATOMIC/ZERO-CAPACITY OVERLOAD, LOWER-RANK HIGH-RATIO CONCENTRATION, HIGH PAIR CODEGREE OR AN ENDPOINT-DISJOINT STAR WITH AN EXACT EXTERNAL-SOURCE RESIDUAL, WITH GAIN PROVENANCE FOR THAT SOURCE ROLE, ISOLATED-CELL PROSPECTIVE STARS, POOL DEPLETION, GLOBAL CONTEXT CAUSES AND LOCAL SUPERREGULAR RESAMPLING REMAINING | `docs/geometric-cleaning.md` |
