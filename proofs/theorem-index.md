...
| GC5 | Clean-host endpoint theorem | OPEN; FIXED-TARGET OVERLOAD DEMAND NOW ROUTES TO NORMALIZED PAYMENT, A HEAVY-RATIO FACTOR FAMILY, AN ATOMIC WEIGHTED OVERLOAD OR A QUANTIFIED SAME-RESOURCE/ROLE HALL-DEFICIENCY FAN, WITH GEOMETRIC CLASSIFICATION OF HIGH RATIOS/FANS, GC4 LABELLED RECURSION, ISOLATED-CELL PROSPECTIVE STARS, POOL DEPLETION, GLOBAL CONTEXT CAUSES AND LOCAL SUPERREGULAR RESAMPLING REMAINING | `docs/geometric-cleaning.md` |
