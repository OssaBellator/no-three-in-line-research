...
| SAS6 | Arithmetic batching or classification of concentrated swap certificates | OPEN; SINGLETON COMPANION CONCENTRATION NOW LOCALIZES TO ONE HEAVY EXACT DEFECT FIBRE AND THEN TO WHOLE-FIBRE REPAIR OR NEAR-COMPLETE DONOR-COMPANION SATURATION, WITH SATURATED-FIBRE DILATION CLASSIFICATION, COMBINED-MOVE GAIN AND HIGH-INCIDENCE/BOUNDARY PROFILES REMAINING | `docs/sparse-algebraic-spread.md` |
