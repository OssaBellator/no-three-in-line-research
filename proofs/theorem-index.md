...
| SAS6 | Arithmetic batching or classification of concentrated swap certificates | OPEN; THE NEGATIVE MIXED-CURVATURE BRANCH NOW HAS AN EXACT PHYSICAL-RECORD QUOTIENT, TWO-USE COLLATERAL BUDGET, AGGREGATE ENERGY ROUTER AND A WEIGHTED DEFECT-TO-DONOR-BANK CONSTRUCTION, WHILE THE OTHER EXACT-SCALE BRANCH IS A COPRIME DONOR-SATURATED PROGRESSION; PROVING USEFUL `K_rec` BOUNDS, EXPLOITING COLLATERAL-DOMINANT HEAVY RECORDS, HIGH-INCIDENCE AND BOUNDARY PROFILES REMAIN | `docs/sparse-algebraic-spread.md` |
