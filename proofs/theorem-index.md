...
| RI5bd–RI5bg | Bank-ready one-target terminal records have exact `1/(mh)` cylinder probability, exact weighted collateral `Q_1/(mh)`, context-pair multiplicity at most two, and a fixed-edge improvement criterion | PROVED UNDER THE BANK-READY PHYSICAL BLOCK HYPOTHESES | `docs/rational-inverse-one-target-bank-audit.md` |
...
| RI6 | Paid physical-lift localization and unconditional bank installation | OPEN; ABSTRACT PRIME-FIELD LABELS, BLOCKER TYPE/PROBABILITY LAW, EXACT PROFILE RECURRENCE AND THE BANK-READY ONE-TARGET COLLATERAL AUDIT ARE CLOSED; TWO-TARGET SECANTS, NON-BANK-READY PHYSICAL LIFTS, ARITHMETIC OWNER PAYMENT AND REPLENISHABLE SOURCES REMAIN | `docs/rational-inverse-expansion.md`; `docs/rational-inverse-one-target-bank-audit.md`; `docs/rational-inverse-profile-recurrence.md` |
