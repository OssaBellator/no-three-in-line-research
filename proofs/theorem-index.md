...
| GC4b | A high-load triple anchor yields pair concentration or an endpoint-disjoint star | PROVED | `tracks/geometric-cleaning-anchor-link.md` |
| GC4c | Bounded pair codegree preserves weighted load in an endpoint-disjoint star | PROVED | `tracks/geometric-cleaning-anchor-link.md` |
...
| GC4k | A Hall-deficient paid incidence contains a same-label compatible star fan or a second-order conflict overload | PROVED | `tracks/geometric-cleaning-anchor-link.md` |
