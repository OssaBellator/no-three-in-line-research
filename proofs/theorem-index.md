...
| SAS6 | Arithmetic batching or classification of concentrated swap certificates | OPEN; DOUBLE-SCOPE AND BOUNDED-COMPANION SINGLETON DEFECTS NOW YIELD WEIGHTED ORIGINAL-PLUS-DONOR WHOLE-FIBRE BATCHES, WHILE SINGLETON FAILURE RETURNS ONE QUANTIFIED COMPANION-COLUMN CONCENTRATION, WITH COMBINED-MOVE GAIN, ARITHMETIC CLASSIFICATION AND HIGH-INCIDENCE/BOUNDARY PROFILES REMAINING | `docs/sparse-algebraic-spread.md` |
