...
| SRR2n–SRR2r | Conditioning changes sublevel deficiency only by threshold-local neighbourhood loss; the min-cost drift is at most their sum and bounded remote assignments cost `k sum_t mu_t` | PROVED UNDER THE LOCAL CONDITIONING-INCIDENCE CONTRACT | `docs/superregular-conditioned-endpoint-cost.md` |
| SRR2s–SRR2u | Left-hole degree `Delta` gives sublevel-rank loss at most `Delta`, a shifted endpoint-cost quantile bound, and an exact aggregate event-load consequence | PROVED UNDER THE BOUNDED LEFT-HOLE CONTRACT | `docs/superregular-bounded-hole-endpoint-flow.md` |
| SRR2 | General superregular lopsided remote-cylinder comparison | OPEN; EXACT REVERSE-FLOW, MINIMAX, LOW-EVENT CUTS, CONDITIONING-LOCAL COST DRIFT AND BOUNDED-LEFT-HOLE SHIFTED QUANTILES IDENTIFIED; A UNIFORM USEFUL LEFT-HOLE/THRESHOLD-INTERSECTION BOUND FOR GENERAL SUPERREGULAR SWITCHING GRAPHS REMAINS | `docs/superregular-resampling.md`; `docs/superregular-conditioned-endpoint-cost.md`; `docs/superregular-bounded-hole-endpoint-flow.md` |
