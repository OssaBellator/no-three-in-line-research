...
| SAS6 | Arithmetic batching or classification of concentrated swap certificates | OPEN; THE NEGATIVE MIXED-CURVATURE BRANCH NOW HAS TWO ORIENTATIONS AND THREE ENDPOINT-INCIDENCE TYPES WITH EXPLICIT `1/24` RETENTION, WHILE THE OTHER EXACT-SCALE BRANCH IS A COPRIME DONOR-SATURATED PROGRESSION; ARITHMETIC CLASSIFICATION OF THE VARYING THIRD COLUMN AND HIGH-INCIDENCE/BOUNDARY PROFILES REMAIN | `docs/sparse-algebraic-spread.md` |
