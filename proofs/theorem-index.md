...
| GC5 | Clean-host endpoint theorem | OPEN; FIXED-TARGET OVERLOAD DEMAND NOW ROUTES TO NORMALIZED PAYMENT, A HEAVY-RATIO FACTOR FAMILY, AN ATOMIC WEIGHTED OVERLOAD, A SAME-DELETED-CELL CONFLICT CLIQUE OR ONE HEAVY EVENT INCIDENCE, WITH PAYMENT/GEOMETRIC CLASSIFICATION OF THE LAST TWO OUTPUTS, ISOLATED-CELL PROSPECTIVE STARS, POOL DEPLETION, GLOBAL CONTEXT CAUSES AND LOCAL SUPERREGULAR RESAMPLING REMAINING | `docs/geometric-cleaning.md` |
