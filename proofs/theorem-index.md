...
| SAS6 | Arithmetic batching or classification of concentrated swap certificates | OPEN; THE NEGATIVE MIXED-CURVATURE BRANCH NOW HAS AN EXACT PHYSICAL-RECORD QUOTIENT AND TWO-USE DONOR-BANK COLLATERAL BUDGET, WHILE THE OTHER EXACT-SCALE BRANCH IS A COPRIME DONOR-SATURATED PROGRESSION; EXPLOITING HEAVY EXACT RECORDS, BUILDING SCALE MASS BEYOND THE TWO-REUSE BUDGET, HIGH-INCIDENCE AND BOUNDARY PROFILES REMAIN | `docs/sparse-algebraic-spread.md` |
