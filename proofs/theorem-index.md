...
| GC5 | Clean-host endpoint theorem | OPEN; FIXED-TARGET OVERLOAD DEMAND NOW ROUTES TO NORMALIZED PAYMENT, ATOMIC/ZERO-CAPACITY OVERLOAD, LOWER-RANK HIGH-RATIO CONCENTRATION, HIGH PAIR CODEGREE OR AN ENDPOINT-DISJOINT CAPACITY-DEFICIENT FACTOR STAR, WITH EXECUTABLE USE OF THOSE STRUCTURES, ISOLATED-CELL PROSPECTIVE STARS, POOL DEPLETION, GLOBAL CONTEXT CAUSES AND LOCAL SUPERREGULAR RESAMPLING REMAINING | `docs/geometric-cleaning.md` |
