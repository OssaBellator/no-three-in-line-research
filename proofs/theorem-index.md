...
| GC5 | Clean-host endpoint theorem | OPEN; PROVED ALL-`n` ENDPOINTS NOW APPLY ONCE GC1–GC4 REACH THEIR NUMERICAL LOAD OR MASS WINDOWS, WITH SOURCE-FAITHFUL LATENT PAYMENT, POOL DEPLETION, GLOBAL CONTEXT CAUSES AND LOCAL SUPERREGULAR RESAMPLING REMAINING | `docs/geometric-cleaning.md` |
