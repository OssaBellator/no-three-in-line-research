...
| SAS6 | Arithmetic batching or classification of concentrated swap certificates | OPEN; DOUBLE-SCOPE REFLECTED DEFECTS NOW YIELD A WEIGHTED ORIGINAL-PLUS-DONOR WHOLE-FIBRE REPAIR BATCH WITH EXPLICIT `d-2` AND `4Lambda+1` LOSSES, WITH COMBINED-MOVE GAIN, SINGLETON FIBRE WEIGHT, ARITHMETIC CLASSIFICATION AND HIGH-INCIDENCE/BOUNDARY PROFILES REMAINING | `docs/sparse-algebraic-spread.md` |
