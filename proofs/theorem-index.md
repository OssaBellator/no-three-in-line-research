...
| GC5 | Clean-host endpoint theorem | OPEN; FIXED-TARGET OVERLOAD DEMAND NOW ROUTES TO NORMALIZED PAYMENT, A HEAVY-RATIO FACTOR FAMILY OR AN EXACT WEIGHTED HALL DEFICIT, WITH GEOMETRIC CONTROL OF HIGH RATIOS/DEFICIENT CLUSTERS, GC4 LABELLED RECURSION, ISOLATED-CELL PROSPECTIVE STARS, POOL DEPLETION, GLOBAL CONTEXT CAUSES AND LOCAL SUPERREGULAR RESAMPLING REMAINING | `docs/geometric-cleaning.md` |
