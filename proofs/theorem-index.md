...
| GC5 | Clean-host endpoint theorem | OPEN; FIXED-TARGET OVERLOAD DEMAND NOW ROUTES TO NORMALIZED PAYMENT, ATOMIC/ZERO-CAPACITY OVERLOAD, LOWER-RANK HIGH-RATIO CONCENTRATION, HIGH PAIR CODEGREE OR AN ENDPOINT-DISJOINT STAR WHOSE EXTERNAL RESIDUAL GIVES A HALL DEFICIT, EXACT GAIN-ROW DESCENT OR ONE PHYSICAL PROVENANCE-DEFICIT ROLE, WITH CLASSIFICATION/REPAIR OF THAT ROLE, ISOLATED-CELL PROSPECTIVE STARS, POOL DEPLETION, GLOBAL CONTEXT CAUSES AND LOCAL SUPERREGULAR RESAMPLING REMAINING | `docs/geometric-cleaning.md` |
