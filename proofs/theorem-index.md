...
| SAS6 | Arithmetic batching or classification of concentrated swap certificates | OPEN; THE NEGATIVE MIXED-CURVATURE BRANCH NOW HAS AN EXACT PHYSICAL-RECORD QUOTIENT, TWO-USE COLLATERAL BUDGET, AGGREGATE ENERGY ROUTER, WEIGHTED DEFECT-TO-DONOR CONSTRUCTION AND THE EXPLICIT STOCK `K_rec<=b*binom(N,3)`, WHILE THE OTHER EXACT-SCALE BRANCH IS A COPRIME DONOR-SATURATED PROGRESSION; EXPLOITING COLLATERAL-DOMINANT HEAVY RECORDS, HIGH-INCIDENCE AND BOUNDARY PROFILES REMAIN | `docs/sparse-algebraic-spread.md` |
