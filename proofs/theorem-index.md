...
| SAS6 | Arithmetic batching or classification of concentrated swap certificates | OPEN; THE NEGATIVE MIXED-CURVATURE BRANCH NOW LOCALIZES TO ONE EXACT THIRD COLUMN AFTER A FINITE PRIMITIVE ROW-RATIO SPLIT, WHILE THE OTHER EXACT-SCALE BRANCH IS A COPRIME DONOR-SATURATED PROGRESSION; ROW-SCALE/BASE-ROW AND REQUIRED-LABEL STRUCTURE, COMPATIBILITY, HIGH-INCIDENCE AND BOUNDARY PROFILES REMAIN | `docs/sparse-algebraic-spread.md` |
