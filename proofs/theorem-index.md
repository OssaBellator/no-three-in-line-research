...
| SRR2 | General superregular lopsided remote-cylinder comparison | OPEN; EXACT REVERSE-FLOW, MINIMAX, LOW-EVENT CUTS AND CONDITIONING-LOCAL COST DRIFT IDENTIFIED; UNIFORM SUPERREGULAR `mu_t` AND DEFICIENCY BOUNDS REMAIN | `docs/superregular-resampling.md`; `docs/superregular-conditioned-endpoint-cost.md` |
