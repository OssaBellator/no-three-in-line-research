...
| GC5 | Clean-host endpoint theorem | OPEN; FIXED-TARGET OVERLOAD DEMAND NOW ROUTES TO NORMALIZED PAYMENT, AN ATOMIC/ZERO-CAPACITY OVERLOAD OR ONE EXACT HIGH-RATIO FACTOR/EVENT INCIDENCE, WITH GEOMETRIC USE OF HIGH RATIOS, ISOLATED-CELL PROSPECTIVE STARS, POOL DEPLETION, GLOBAL CONTEXT CAUSES AND LOCAL SUPERREGULAR RESAMPLING REMAINING | `docs/geometric-cleaning.md` |
