...
| S3 | Candidate-only triple energy is `Omega(delta^3 n^4 log n)` | PROVED | `docs/02-reverse-scale-switching.md` |
...
| L3 | Anchor-load cap implies `A_2<=8nTheta` | PROVED | `docs/03-uniform-local-bank.md` |
...
| B1 | High line meets an order-`h` block at most once when `h<=H` | PROVED | `docs/06-block-collateral-energy.md` |
...
| H5 | Hamiltonian-cycle decomposition by `ord(b/a)` | PROVED | `docs/08-hyperbola-interleaver.md` |
