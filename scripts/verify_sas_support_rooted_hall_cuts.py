#!/usr/bin/env python3
"""Deterministic finite audit for SAS5nk--SAS5nn."""
...
def main():
    ...
    for seed in range(500017,502517):
        for k,v in audit(seed).items():total[k]+=v
    expected={'vertices':49928,'edges':44793,'roots':8428,'selected_roots':4147,'closure_vertices':9851,'shortfall':5172,'balanced':335,'rectangle_pairs':1209,'predicate_pairs':782}
    assert dict(total)==expected,(dict(total),expected)
    print('SAS5nk--SAS5nn audit passed:',expected)
