...
const std::array<uint64_t,14> EXPECTED_ORDERS={{1,2,4,7,7,12,48,48,62,254,684,2012,8856,75600}};
const std::array<uint64_t,14> EXPECTED_TOP_NODES={{2,5,13,30,48,163,550,551,901,3070,8134,28175,135315,220298}};
const std::array<uint64_t,14> EXPECTED_BOTTOM_NODES={{1,3,7,10,10,15,59,59,76,338,900,2613,12077,110263}};
...
int main(){
    ...
    assert(keep_mask==0);
    std::cout<<"empty_top_assumption_core top_orders=75600 top_nodes=220298 bottom_nodes=110263 PASS\n";
}
