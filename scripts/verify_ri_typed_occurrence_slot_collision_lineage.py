#!/usr/bin/env python3
"""Deterministic audit for RI5fn--RI5fr."""
...
def main():
    ...
    for _ in range(SYSTEMS):
        ...
        for _claim in range(rng.randint(1, 4)):
            ...
            left_type = rng.choice(["owner", "charge"])
            right_type = rng.choice(["owner", "charge"])
    ...
    print("RI typed occurrence-slot collision lineage audit passed")
