#!/usr/bin/env python3
"""Deterministic finite audit for GC2ml--GC2mo."""
...
def main():
    ...
    for seed in range(200017,202517):
        for k,v in audit(seed).items():total[k]+=v
    expected={'vertices':50062,'edges':44529,'roots':8737,'selected_roots':4200,'closure_vertices':9602,'shortfall':5351,'balanced':334,'rectangle_pairs':1255,'predicate_pairs':827}
    assert dict(total)==expected,(dict(total),expected)
    print('GC2ml--GC2mo audit passed:',expected)
