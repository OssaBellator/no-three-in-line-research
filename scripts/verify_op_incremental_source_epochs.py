...
def main():
    ...
    print(f"verified {systems} OP epochs, {boundary_checks} boundary pairs, {corrupted} corruptions, {complete} complete and {deficient} deficient updates")
