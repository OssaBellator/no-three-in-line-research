#!/usr/bin/env python3
"""Verify the GC occurrence-slot assignment Hall-core interface."""
from random import Random

SEED, SYSTEMS, TYPED, P = 2504, 2600, False, 0.40
...
def main():
    ...
    print("GC occurrence-slot assignment Hall-core audit"); print(f"systems={SYSTEMS}")
