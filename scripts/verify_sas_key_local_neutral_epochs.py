#!/usr/bin/env python3
"""Finite audit for SAS5nc--SAS5nf."""
...
def main():
    ...
    print(f"SAS keyed epochs: {accepted}"); print(f"key-local/full pairs: {stats['boundary']}/{stats['full_pairs']}"); print(f"deficient updates: {stats['deficient']}"); print(f"total deficit/churn: {stats['deficit']}/{stats['churn']}")
