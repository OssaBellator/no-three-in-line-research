#!/usr/bin/env python3
"""Verify the OP typed occurrence-slot assignment Hall-core interface."""
from random import Random

SEED, SYSTEMS, TYPED, P = 2505, 2800, True, 0.44
...
def main():
    ...
    print("OP typed occurrence-slot assignment Hall-core audit"); print(f"systems={SYSTEMS}")
