#!/usr/bin/env python3
"""Deterministic audit for SAS5lt--SAS5lx."""
...
def main():
    ...
    for _ in range(SYSTEMS):
        ...
        for _claim in range(rng.randint(1, 4)):
            ...
            if rng.choice(["pair", "completion"]) != rng.choice(["pair", "completion"]):
    ...
    print("SAS typed occurrence-slot collision lineage audit passed")
