...
def main():
    ...
    for _ in range(SYSTEMS):
        n, edges, source, sink, demand, _types = MAKE_SYSTEM(rng)
    ...
    print("SRR cut-arc collision audit passed")
