#!/usr/bin/env python3
"""Deterministic replay audit for RI5gc--RI5gg."""
from collections import Counter
from random import Random

FAULTS=("source_less","split","reuse","hidden_deposit","class_mismatch")
SEED,SYSTEMS=2602,2600
EXPECTED={"systems":2600,"initial":19353,"events":50859,"deposits":17778,"transitions":7857,"selected":24968,"class_checks":254380,"valid":1130,"invalid":1470}
EXPECTED_FAULTS={"class_mismatch":292,"split":292,"hidden_deposit":256,"reuse":314,"source_less":316}
EXPECTED_TYPES={1:12488,0:12480}
...
def main():
    ...
    print("RI typed repair-collateral audit:",dict(totals)); print("typed debits:",dict(types)); print("first failures:",dict(faults))
