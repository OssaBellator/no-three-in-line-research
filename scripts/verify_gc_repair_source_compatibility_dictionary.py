#!/usr/bin/env python3
"""Deterministic audit for the GC repair-source compatibility dictionary."""
from collections import Counter
from random import Random

SYSTEMS, SEED = 2600, 28004
...
def main():
    got = audit()
    expected = {'systems': 2600, 'incidences': 19352, 'tokens': 26989, 'fail_missing_true_edge': 312, 'pair_checks': 214401, 'true_edges': 20429, 'stored_edges': 20389, 'selected_debits': 19352, 'valid': 1170, 'fail_stale_epoch': 268, 'fail_spurious_false_edge': 272, 'fail_omitted_field': 290, 'fail_relabelled_address': 288}
