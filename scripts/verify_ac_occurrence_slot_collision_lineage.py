#!/usr/bin/env python3
"""Deterministic audit for AC5el--AC5ep."""
...
def main():
    ...
    assert out["claims"] == (
        out["double_consumption"]
        + out["noninjective_slot"]
        + out["missing_lineage"]
    )
    print("AC occurrence-slot collision lineage audit passed")
