#!/usr/bin/env python3
"""Verify the RI typed occurrence-slot assignment Hall-core interface."""
from random import Random

SEED, SYSTEMS, TYPED, P = 2503, 2600, True, 0.42
...
def main():
    ...
    print("RI typed occurrence-slot assignment Hall-core audit"); print(f"systems={SYSTEMS}")
