#!/usr/bin/env python3
"""Analyze PP3in--PP3iw endpoint-trade hosts on stored certificates.
...
endpoint-index support rank, and searches exactly for a source-admissible
perfect matching of the safe host.
"""
...
def count_patterns(
    ...
    for first, second in itertools.combinations(edges, 2):
        ...
        if any(determinant(first_cell, second_cell, anchor) == 0 for anchor in fixed):
