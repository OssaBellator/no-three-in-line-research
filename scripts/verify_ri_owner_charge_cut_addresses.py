TITLE='RI owner-charge cut-address audit'
SEED=1803
SYSTEMS=5000
STAGES=2
ORDER=['systems','capacity_classes','terminal_classes','compatibility_arcs','demand_units','paid_units','unpaid_units','deficient_systems','outside_terminal_classes','type0_outside_units','type1_outside_units','stage0_cut_units','stage1_cut_units']
