...
const Assignment FULL_TOP={{0,1,3,2,5,4,6,0,3,1,2,6,5,4}};
const std::array<uint64_t,14> EXPECTED_ORDERS={{1,1,1,3,6,15,55,55,55,230,568,1228,11974,70376}};
const std::array<uint64_t,14> EXPECTED_TOP_NODES={{2,3,4,14,28,112,377,378,379,2009,4652,9750,98000,232939}};
const std::array<uint64_t,14> EXPECTED_BOTTOM_NODES={{1,1,1,3,6,16,80,80,80,373,982,2013,15826,95298}};
...
int main(){
    ...
    assert(keep_mask==0);
    std::cout<<"empty_top_assumption_core top_orders=70376 top_nodes=232939 bottom_nodes=95298 PASS\n";
}
