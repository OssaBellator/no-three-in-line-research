...
assert sum(value for value, total in CANDIDATE_FIELDS.values()) == 23
...
print(
    {
        ...
        "new_source_identification_results": {
            "boundary": "210092 exact five-point refills fail",
            "Hall": "72 one-free-resource lifts are uniformly single-exclusion robust",
            "threshold": "unique legal augmentation requires degree-five source margins and one extra slot",
            "prefix": "distinct unary-run points give aggregate 396499770810 guaranteed triples",
            "shell": "recorded source monoid remains in the even-sum lattice",
        },
