#!/usr/bin/env python3
"""Finite verifier for SRR2gk--SRR2gn."""
...
def main():
    rng=random.Random(505); systems=jobs=arrivals=oversized=shortages=0
    for _ in range(2500):
        ...
        systems+=1; jobs+=n
    print(f"verified {systems} SRR queues, {jobs} jobs, {arrivals} admissions")
