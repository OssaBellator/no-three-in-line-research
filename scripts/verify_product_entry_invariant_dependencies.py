...
INDEXES = [ROOT / "proofs" / name for name in (
    ...
    "product-growing-direction-theorem-index-PX533-PX536.md",
    "product-growing-direction-theorem-index-PX537-PX540.md",
    "product-growing-direction-theorem-index-PX541-PX545.md",
    "product-growing-direction-theorem-index-PX546-PX550.md",
)]
DOCS = [ROOT / "docs" / name for name in (
    ...
    "180-side-seven-radius-two-support-fourteen-csp.md",
    "181-side-seven-cycle322-complete-radius-two-obstruction.md",
    "182-side-seven-cycle43-complete-radius-two-obstruction.md",
    "183-side-seven-radius-three-selector-layers.md",
)]
...
def main() -> None:
    ...
    assert manifest["range"] == "PX397-PX550"
    assert manifest["root"] == "PX492"
    assert manifest["frontier_root"] == "PX550"
    ...
    for theorem_id in range(397, 551):
    ...
    assert index_ids == list(range(397, 551))
    ...
    print("PX397--PX550 dependency, cutoff, and radius-three frontier audit: PASS")
