...
namespace {
constexpr int GLOBAL_CASE=9;
const Assignment FULL_TOP={{0,1,6,4,5,3,2,2,0,4,3,6,1,5}};
const std::array<uint64_t,14> EXPECTED_ORDERS={{1,1,2,4,6,10,54,54,82,164,530,1720,7212,51932}};
const std::array<uint64_t,14> EXPECTED_TOP_NODES={{2,3,7,16,33,56,274,275,541,1083,3483,11728,46673,178937}};
const std::array<uint64_t,14> EXPECTED_BOTTOM_NODES={{1,1,3,7,10,17,88,88,121,237,732,2409,10562,82849}};
...
int main(){
    ...
    assert(keep_mask==0);
    std::cout<<"empty_top_assumption_core top_orders=51932 top_nodes=178937 bottom_nodes=82849 PASS\n";
}
