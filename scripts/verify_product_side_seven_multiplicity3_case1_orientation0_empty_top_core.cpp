...
namespace {
constexpr int GLOBAL_CASE=1;
const Assignment FULL_TOP={{0,2,1,6,5,3,4,2,0,4,5,6,1,3}};
const std::array<uint64_t,14> EXPECTED_ORDERS={{1,1,1,2,10,14,50,50,76,296,596,2176,7800,62416}};
const std::array<uint64_t,14> EXPECTED_TOP_NODES={{2,3,4,9,62,170,812,813,1044,3176,6547,24027,78219,211067}};
const std::array<uint64_t,14> EXPECTED_BOTTOM_NODES={{1,1,1,3,13,18,75,75,101,389,764,3022,12202,96353}};
...
int main(){
    ...
    assert(keep_mask==0);
    std::cout<<"empty_top_assumption_core top_orders=62416 top_nodes=211067 bottom_nodes=96353 PASS\n";
}
