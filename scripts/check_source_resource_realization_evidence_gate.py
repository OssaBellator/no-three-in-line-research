...
print({
    ...
    "new_source_resource_results": {
        "boundary": "minimum six-point degree-preserving corrector exists; 2080 raw seventh-block attempts fail",
        "Hall": "K_3,3 minus any partial matching survives one additional cell exclusion",
        "threshold": "integer dual forces at least one augmentation per source period",
        "prefix": "1024 unary-run compositions admit distinct row-column embeddings with no cross-run triples",
        "shell": "docs/499, 505, 511, and 517 preserve the even-sum fixed-column lattice",
    },
