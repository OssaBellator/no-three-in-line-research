#!/usr/bin/env python3
"""Deterministic audit for RI5fi--RI5fm."""
from collections import defaultdict
from importlib import import_module
from random import Random
BASE=import_module("verify_ri_typed_cut_arc_collision_pairs")
FLOW,UNIT_PATHS,ENABLED=BASE.FLOW,BASE.unit_paths,BASE.ENABLED
SEED,SYSTEMS=2403,2000
...
def main():
    ...
    print("RI typed collision-segment audit passed")
