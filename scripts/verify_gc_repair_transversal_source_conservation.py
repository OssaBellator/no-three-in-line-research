#!/usr/bin/env python3
"""Deterministic replay audit for GC2lj--GC2ln."""
from collections import Counter
from random import Random

FAULTS=("source_less","split","reuse","hidden_deposit","class_mismatch")
SEED,SYSTEMS=2603,2600
EXPECTED={"systems":2600,"initial":19442,"events":51133,"deposits":17619,"transitions":7976,"selected":25255,"class_checks":256497,"invalid":1416,"valid":1184}
EXPECTED_FAULTS={"reuse":295,"hidden_deposit":283,"split":259,"source_less":292,"class_mismatch":287}
...
def main():
    ...
    print("GC repair-source audit:",dict(totals)); print("first failures:",dict(faults))
