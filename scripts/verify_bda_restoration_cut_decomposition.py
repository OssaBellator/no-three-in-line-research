TITLE='BDA restoration-cut decomposition audit'
SEED=1802
SYSTEMS=6000
STAGES=2
ORDER=['systems','capacity_classes','terminal_classes','compatibility_arcs','demand_units','paid_units','unpaid_units','deficient_systems','outside_terminal_classes','stage0_cut_units','stage1_cut_units']
