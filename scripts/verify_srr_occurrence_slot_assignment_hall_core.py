#!/usr/bin/env python3
"""Verify the SRR occurrence-slot assignment Hall-core interface."""
from random import Random

SEED, SYSTEMS, TYPED, P = 2506, 2800, False, 0.39
...
def main():
    ...
    print("SRR occurrence-slot assignment Hall-core audit"); print(f"systems={SYSTEMS}")
