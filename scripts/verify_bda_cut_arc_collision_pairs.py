...
def unit_paths(n, edges, source, sink, used):
    ...
    while any(amount > 0 for amount in remaining.values()):
        ...
        while cursor != source:
            ...
            nodes.append(previous); keys.append(key); cursor = previous
...
def main():
    ...
    print("BDA cut-arc collision audit passed")
