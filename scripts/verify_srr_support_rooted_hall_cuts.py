#!/usr/bin/env python3
"""Deterministic finite audit for SRR2fu--SRR2fx."""
...
def main():
    ...
    for seed in range(400017,402517):
        for k,v in audit(seed).items():total[k]+=v
    expected={'vertices':50128,'edges':45325,'roots':8159,'selected_roots':4095,'closure_vertices':9661,'shortfall':5050,'balanced':332,'rectangle_pairs':1294,'predicate_pairs':821}
    assert dict(total)==expected,(dict(total),expected)
    print('SRR2fu--SRR2fx audit passed:',expected)
