#!/usr/bin/env python3
"""Deterministic audit for the SRR repair-witness compatibility dictionary."""
from collections import Counter
from random import Random

SYSTEMS, SEED = 2800, 28006
...
def main():
    got = audit()
    expected = {'systems': 2800, 'incidences': 21142, 'tokens': 29660, 'valid': 1263, 'pair_checks': 238273, 'true_edges': 22364, 'stored_edges': 22383, 'selected_debits': 21142, 'fail_spurious_false_edge': 301, 'fail_relabelled_address': 311, 'fail_stale_epoch': 317, 'fail_missing_true_edge': 282, 'fail_omitted_field': 326}
