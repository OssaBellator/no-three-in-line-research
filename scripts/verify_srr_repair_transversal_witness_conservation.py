#!/usr/bin/env python3
"""Deterministic replay audit for SRR2es--SRR2ew."""
from collections import Counter
from random import Random

FAULTS=("source_less","split","reuse","hidden_deposit","class_mismatch")
SEED,SYSTEMS=2805,2800
EXPECTED={"systems":2800,"initial":21018,"events":54827,"deposits":18986,"transitions":8540,"selected":27002,"class_checks":276158,"invalid":1517,"valid":1283}
EXPECTED_FAULTS={"reuse":317,"class_mismatch":301,"source_less":299,"split":301,"hidden_deposit":299}
...
def main():
    ...
    print("SRR repair-witness audit:",dict(totals)); print("first failures:",dict(faults))
