...
namespace {
constexpr int GLOBAL_CASE=3;
const Assignment FULL_TOP={{0,1,6,3,2,4,5,2,0,4,5,6,1,3}};
const std::array<uint64_t,14> EXPECTED_ORDERS={{1,1,1,1,1,3,24,24,30,140,296,1096,3756,34516}};
const std::array<uint64_t,14> EXPECTED_TOP_NODES={{2,3,4,7,12,61,313,314,380,1396,2276,3863,46045,123241}};
const std::array<uint64_t,14> EXPECTED_BOTTOM_NODES={{1,1,1,1,1,4,39,39,47,230,432,1751,5988,52323}};
...
int main() {
    ...
    assert(keep_mask==0);
    std::cout<<"empty_top_assumption_core top_orders=34516 top_nodes=123241 bottom_nodes=52323 PASS\n";
}
