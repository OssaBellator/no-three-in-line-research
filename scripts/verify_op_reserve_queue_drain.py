#!/usr/bin/env python3
"""Finite verifier for OP4ha--OP4hd."""
...
def main():
    rng=random.Random(404); systems=jobs=arrivals=oversized=shortages=0
    for _ in range(2500):
        ...
        systems+=1; jobs+=n
    print(f"verified {systems} OP queues, {jobs} jobs, {arrivals} admissions")
