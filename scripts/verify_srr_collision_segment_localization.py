#!/usr/bin/env python3
"""Deterministic audit for SRR2dy--SRR2ec."""
from collections import defaultdict
from importlib import import_module
from random import Random
BASE=import_module("verify_srr_cut_arc_collision_pairs")
FLOW,UNIT_PATHS,ENABLED=BASE.FLOW,BASE.unit_paths,BASE.ENABLED
SEED,SYSTEMS=2406,2200
...
def main():
    ...
    print("SRR collision-segment audit passed")
