#!/usr/bin/env python3
"""Audit OP4du--OP4dy: canonical irreducible residual/edit cores."""
from collections import deque
import random
SEED, SYSTEMS = 18005, 4300
...
def main():
    rng=random.Random(SEED); z={k:0 for k in ("checks","deficient","addresses","deficit","marginal","single","residual","edit")}
    for _ in range(SYSTEMS):
        ...
        for x in addr:
            ...
            z["residual" if a[7][x]==0 else "edit"]+=a[6][x]
    print("OP4du--OP4dy audit passed")
    ...
    print(f"residual demand units in cores: {z['residual']:,}")
    print(f"edit demand units in cores: {z['edit']:,}")
