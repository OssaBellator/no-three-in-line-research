...
namespace {
constexpr int GLOBAL_CASE=6;
const Assignment FULL_TOP={{0,1,6,3,2,4,5,2,0,3,5,6,4,1}};
const std::array<uint64_t,14> EXPECTED_ORDERS={{1,1,1,1,3,8,50,50,62,124,276,880,10572,51276}};
const std::array<uint64_t,14> EXPECTED_TOP_NODES={{2,3,4,7,19,193,666,667,787,1575,3939,11641,123271,152166}};
const std::array<uint64_t,14> EXPECTED_BOTTOM_NODES={{1,1,1,1,5,13,62,62,75,152,344,1106,13953,83589}};
...
int main() {
    ...
    assert(keep_mask==0);
    std::cout<<"empty_top_assumption_core top_orders=51276 top_nodes=152166 bottom_nodes=83589 PASS\n";
}
