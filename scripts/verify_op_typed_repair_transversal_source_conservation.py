#!/usr/bin/env python3
"""Deterministic replay audit for OP4fi--OP4fm."""
from collections import Counter
from random import Random

FAULTS=("source_less","split","reuse","hidden_deposit","class_mismatch")
SEED,SYSTEMS=2804,2800
EXPECTED={"systems":2800,"initial":21207,"events":54773,"deposits":18924,"transitions":8507,"selected":27015,"class_checks":277261,"valid":1267,"invalid":1533}
EXPECTED_FAULTS={"hidden_deposit":327,"reuse":292,"class_mismatch":294,"split":316,"source_less":304}
EXPECTED_TYPES={1:13428,0:13587}
...
def main():
    ...
    print("OP typed repair-source audit:",dict(totals)); print("typed debits:",dict(types)); print("first failures:",dict(faults))
