...
{36,163},{36,164},{37,162},{37,165},{38,163},{38,164},{39,162},{39,165}
 ...
 for(auto const&node:nodes){
  for(int off=-64;off<=64;off++){
   vector<Pt> block;for(auto p:node.pts)block.push_back({40+p.x,162+off+p.y});
