...
stats = {
    ...
    "compatibility_arcs": 0, "demand_units": 0, "paid_units": 0,
    "deposit_units": 0, "deficient_epochs": 0, "unpaid_units": 0,
    "hall_subset_checks": 0,
}

for _ in range(SYSTEMS):
    owner_count = rng.randint(1, 3)
    charge_count = rng.randint(1, 3)
    source_count = rng.randint(2, 5)
    demand_count = owner_count + charge_count
