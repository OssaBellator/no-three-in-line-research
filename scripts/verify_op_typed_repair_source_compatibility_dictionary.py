#!/usr/bin/env python3
"""Deterministic audit for the OP typed repair-source compatibility dictionary."""
from collections import Counter
from random import Random

SYSTEMS, SEED = 2800, 28005
...
def audit():
    ...
    for _ in range(SYSTEMS):
        ...
        out["residual"] += sum(a[0] == 0 for a in inc); out["edit"] += sum(a[0] == 1 for a in inc)
    return out


def main():
    got = audit()
    expected = {'systems': 2800, 'incidences': 20919, 'tokens': 29379, 'valid': 1245, 'pair_checks': 234018, 'true_edges': 22700, 'stored_edges': 22736, 'selected_debits': 20919, 'residual': 10481, 'edit': 10438, 'fail_omitted_field': 312, 'fail_stale_epoch': 299, 'fail_spurious_false_edge': 340, 'fail_missing_true_edge': 304, 'fail_relabelled_address': 300}
    ...
    print(f"residual={got['residual']} edit={got['edit']}")
