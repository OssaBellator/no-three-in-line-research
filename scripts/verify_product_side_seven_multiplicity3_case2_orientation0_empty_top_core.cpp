...
namespace {
constexpr int GLOBAL_CASE=2;
const Assignment FULL_TOP={{0,1,6,3,2,4,5,2,0,3,5,6,1,4}};
const std::array<uint64_t,14> EXPECTED_ORDERS={{1,1,1,1,3,8,50,50,62,124,276,880,5404,51276}};
const std::array<uint64_t,14> EXPECTED_TOP_NODES={{2,3,4,7,19,193,666,667,787,1575,3939,11641,71157,152166}};
const std::array<uint64_t,14> EXPECTED_BOTTOM_NODES={{1,1,1,1,5,13,62,62,75,152,344,1106,8418,83589}};
