...
## AC5ap -- sharp admissible density after paid pool depletion -- PROVED
...
## AC5aq -- restriction cannot create pair-shadow mass -- PROVED
...
## AC5ar -- exact new-cell pair-shadow inventory -- PROVED
...
## AC5as -- pathwise charged threshold-crossing bound -- PROVED
...
Suppose every old--new or new--new incidence counted by AC5ar is assigned to a paid current event atom,
...
AC5ar gives more than `eta` charged units for every crossing anchor. All crossings therefore require
...
## AC5at -- complete GC1--GC3 event interface for one AC menu -- PROVED UNDER THE DECLARED INVENTORY CONTRACT
...
6. an occurrence-faithful charge of all AC5ar old--new and new--new incidences to paid current event atoms with reuse at most `R`.
...
Apply AC5ap to partner density, AC5aq to the restriction stage, AC5ar to every addition stage and AC5as
to the pathwise threshold crossings. The declared new-blocker atoms cover the only partner failures
excluded from AC5ap. QED.
