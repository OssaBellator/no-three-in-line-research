...
The branch still lacks the genuine source proofs, exhaustive recurrence theorem, complete populated
construction, arbitrary-`n` geometry theorem, semantic proofs, global-family theorem, all chamber proofs,
