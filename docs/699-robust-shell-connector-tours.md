...
minimum tour. In the robust shell problem, connector burdens depend on the
uncertainty vertex. This chapter records the correct vector-valued tour and
repayment objectives.

## PP3dfd — Minimax vector connector tour
...
## PP3dfe — Exact three-component uncertainty census
...
## PP3dff — Joint tour and repetition optimization
...
The all-`n` theorem remains open, and the next theorem identifier is `PP3dfg`.
