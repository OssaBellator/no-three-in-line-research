...
## PP3deo — Exact incidence-realizable packet class
...
## PP3dep — Exact transfer rates and Hall thresholds
...
## PP3deq — Direct-chain verification and explicit defect template
...
The all-`n` theorem remains open, and the next theorem identifier is `PP3der`.
