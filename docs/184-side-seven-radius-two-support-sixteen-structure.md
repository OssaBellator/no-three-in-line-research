...
support sixteen. PX537--PX545 subsequently close the complete `(3,2,2)` and
`(4,3)` radius-two layers, while PX546--PX550 enumerate their radius-three
frontiers. This chapter classifies the support-sixteen graphs across all four
relative classes and identifies which two-step paths can use a 4-cycle.
...
### Corollary PX554 -- PROVED REDUCTION
