...
support sixteen.  Before launching the full coordinate census, this chapter
classifies their balanced support graphs and their two-step path structure.
...
### Corollary PX540 -- PROVED REDUCTION
