# Rational-inverse typed repair-collateral compatibility Hall cores

## Contract

Fix a finite ordered repair epoch after the deficit-sized transversal and source-conservation steps. Let `R` be the unit set of selected owner/charge repair incidences and let `T` be the current unit set of live physical/collateral repair tokens. Every incidence and token retains its conserved arithmetic source class and the complete owner/charge type, physical source, collateral, terminal arithmetic and perturbation fields.
...
```text
python scripts/verify_ri_typed_repair_collateral_compatibility_hall_core.py
```

The fixed audit checks:

- systems: `2,600`
- conserved classes: `7,800`
- selected incidences: `23,344`
- live tokens: `31,128`
- old compatible pairs: `42,871`
- Hall subset checks: `88,904`
- complete systems: `320`
- deficient systems: `2,280`
- canonical deficient class cores: `4,171`
- deficit units / exact minimum new pairs: `5,562`
- missing-rectangle pairs: `27,470`
- proper-core checks: `17,386`
- mixed typed cores: `1,221`

## Scope

This is conditional on the complete typed repair-collateral compatibility, arithmetic-field and unit-token contract. It does not construct the concrete arithmetic or geometric compatibility predicates, prove the endpoint theorem for this track, or prove the no-three-in-line conjecture.
