...
- every clean pair has exactly two canonical role states supported on its five columns;
- arbitrary support-disjoint role choices form a legal two-layer product;
...
- AC3fw--AC3fy: union-safe companion rectangle payment.
