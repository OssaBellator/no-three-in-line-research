...
## 6. Revised parity-clean frontier

### Corollary PP3blm -- PROVED / FRONTIER SHARPENED
...
This gives a polynomially computable parity-clean macro action. The remaining
asymptotic gaps are precise:
