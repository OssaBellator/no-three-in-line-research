...
### Theorem PP3bni -- VERIFIED FINITELY / CRITICAL SUPPORT CLASSIFICATION
...
### Theorem PP3bnj -- VERIFIED FINITELY / FIRST-STEP PROFILE
...
### Proposition PP3bnk -- PROVED / IMPLICIT MACRO PREDECESSORS
...
### Theorem PP3bnl -- VERIFIED FINITELY / COMPLETE CLEAN-MACRO REACHABILITY
...
from the 28 valid states, and applies PP3bnk without materializing the macro edge
...
### Corollary PP3bnm -- VERIFIED FINITELY / SHARP WITNESS COLLAPSE

The 32 sharp three-owner states from PP3bni have exact parity-clean macro-distance
distribution
...
complete macro search of PP3bnl.  Reading their verified distances gives the
