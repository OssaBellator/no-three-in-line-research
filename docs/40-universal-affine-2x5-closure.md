...
either layer `tau=tau_s`. By PX31 and PX31a, there exist
...
PX31 guarantees exactly four valid affine pairs. The search is constant-size;
the coordinate output is linear in the 20 resulting cells.

## 5. Boundary

PX32 is the first factor-independent closure statement in this branch, but it
