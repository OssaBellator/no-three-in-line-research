...
PX84 shows that affine coset states stop gaining entropy after rank two.  This
...
permutation.  This is the first local unit/injectivity requirement in PX81,
without restricting `Phi` to be affine.
...
a permutation.  This is the second PX81 requirement.
...
## Theorem PX86 -- PROVED CONDITIONALLY
...
matching.  PX85 supplies protection, and independence across cosets multiplies
...
uniform simultaneous multi-colour rank-three cylinder bound assumed in PX86.
...
They coincide in number with the 100 affine local states of PX81.
...
PX86 turns the protected-spread problem into a precise rainbow-matching
statement:
...
Once the cylinder bound is available, PX71 supplies the high-direction conflict
codegree saving and PX79 supplies a local-load endpoint.
