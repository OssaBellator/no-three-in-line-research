...
### Theorem PP3bkr -- PROVED / EXACT REDUCTION
...
PP3bkq makes that predicate invariant under simultaneous complementation, so it
...
### Proposition PP3bkt -- VERIFIED FINITELY
...
power of two predicted by PP3bks.
...
### Corollary PP3bku -- PROVED / FRONTIER REFINED
