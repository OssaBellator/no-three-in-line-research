...
This chapter complements three preceding carry-classification results:
...
- [`25-perfect-alignment-arithmetic.md`](25-perfect-alignment-arithmetic.md) classifies the perfect-alignment parameters and proves reduced-denominator sparsity.
...
The reduced-denominator theorem PA3 gives a complementary global bound: a positive-density perfect-alignment class must have bounded interpolation denominator.
...
CF1–CF6 and PA1–PA3 refine its structural outputs:

- same-channel stars have anchor-specific cross-carry dispersion;
- perfect-alignment parameters have bounded reduced denominator at positive density;
- perfect-alignment cells have explicit rational centers;
- every perfect-wrap chamber has divisor-controlled occupancy.

No high-load branch is now anonymous. The remaining issue is termination: one must prove that repeated alternating propagation cannot indefinitely create new carry signatures and wrap centers without either exhausting their finite budget or entering an absorbable bounded-denominator algebraic exception.
...
- reduced interpolation denominators from PA3;
