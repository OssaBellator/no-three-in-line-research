...
candidate triple has one canonical owner before sampling.  If
...
\[
\boxed{\mathbb E N(R)=\sum_a p_e(a)g_e(a).}
\]

The marginal matrix is doubly stochastic, so expected collateral is one exact
